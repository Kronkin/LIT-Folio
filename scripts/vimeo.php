...
class phpVimeo
{
    ...
    private function _request($method, $call_params = array(), $request_method = 'GET', $url = self::API_REST_URL, $cache = true, $use_auth_header = true)
    {
        ...
        if (strtoupper($request_method) == 'GET') {
            ...
            $curl_url = $url;
            $curl_opts = array(
				//CURLOPT_REFERER => "http://eamonnhealy.com/www/vimeo-vimeo-php-lib-67f1410/upload.php";			   
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_TIMEOUT => 30,
                CURLOPT_POST => true,
		...
		//curl_setopt ($curl, CURLOPT_REFERER, "http://eamonnhealy.com/www/vimeo-vimeo-php-lib-67f1410/upload.php");	
